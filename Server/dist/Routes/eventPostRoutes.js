...
router.post('/eventsPosts', authMiddleware_1.authenticateToken, validationMiddleware_1.userMessageValidation, validationMiddleware_1.societyValidation, validationMiddleware_1.eventValidation, eventPostsController_1.createEventPost);
...
router.post('/eventsPosts/:eventPostId/replies', authMiddleware_1.authenticateToken, validationMiddleware_1.userMessageValidation, eventRepliesController_1.createEventReply);
